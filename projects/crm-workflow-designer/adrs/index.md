# ADR Index — CWFD-001 CRM Visual Workflow Designer

| ADR | Title | Status | Date | Decided by |
|-----|-------|--------|------|------------|
| ADR-001 | React Flow Canvas Library Selection | Accepted | 2026-06-01 | Architect |
| ADR-002 | Adapter Pattern for Dual-Environment CRM Communication | Accepted | 2026-06-01 | Architect |
| ADR-003 | Zustand Flat-Map State Architecture | Accepted | 2026-06-01 | Architect |
| ADR-004 | Auto-Layout Engine: ELK Primary + Dagre Fallback with Web Worker | Accepted | 2026-06-01 | Architect |
