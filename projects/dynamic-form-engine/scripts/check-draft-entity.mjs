...
const body = new URLSearchParams({ grant_type: 'client_credentials', client_id: '08e80e93-0bab-45ef-8372-2e554fa9af9b', client_secret: process.env.DV_CLIENT_SECRET, scope: DATAVERSE_URL + '/.default' });
