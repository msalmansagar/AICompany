/**
 * The approved icon set, ported verbatim from `prototype/shared/icons.js`.
 *
 * The paths are the design baseline: they are copied, not redrawn. A 16×16 viewBox and
 * `currentColor` throughout is what lets an icon inherit the colour of whatever it sits in, which is
 * how the prototype's command bar and navigation behave.
 */
...
/** Every icon the approved baseline defines. Used by tests to prove none was lost in the port. */
