...
namespace Qdb.DebtCollection.Plugins.Tests.Infrastructure
{
    /// <summary>
    ...
    public sealed class PluginContextBuilder
    {
        ...
        /// <summary>
        /// The three services wrapped as the parameter object the plugin shells build,
        /// for logic classes that take a <see cref="global::Qdb.DebtCollection.Plugins.Infrastructure.PluginContext"/>.
        /// </summary>
        public global::Qdb.DebtCollection.Plugins.Infrastructure.PluginContext PluginContext =>
            new global::Qdb.DebtCollection.Plugins.Infrastructure.PluginContext(Service, Tracing, Context);
