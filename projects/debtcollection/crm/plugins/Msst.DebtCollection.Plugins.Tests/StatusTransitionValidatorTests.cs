...
namespace Msst.DebtCollection.Plugins.Tests
{
    public sealed class StatusTransitionValidatorTests
    {
        ...
        public void ValidateTransition_CaseNoStatusCodeChange_AllowsUpdate()
        {
            ...
            target["msst_casereason"] = "Updated reason only";
        ...
        [Fact]
        public void ValidateTransition_PtpOpenToKept_AllowsTransition()
        {
            // Arrange
        ...
        [Fact]
        public void ValidateTransition_PtpOpenToBroken_AllowsTransition()
        {
            // Arrange
            var validator = BuildPtpValidator(
                StatusTransitionMatrix.PtpStatus.Open,
        ...
        [Fact]
        public void ValidateTransition_PtpKeptToOpen_ThrowsInvalidPluginExecutionException()
        {
        ...
        public void ValidateTransition_PtpNoStatusChange_AllowsUpdate()
        {
            ...
            preImage["statuscode"] = new OptionSetValue(StatusTransitionMatrix.PtpStatus.Open);
            builder.WithPreImage(preImage);

            var target = new Entity(EntityPtp);
            target["msst_reminderdate"] = DateTime.Today.AddDays(1);
            builder.WithTarget(target);
        ...
        public void ValidateTransition_PtpNoPreImage_AllowsTransition()
        {
            ...
            var target = new Entity(EntityPtp);
            target["statuscode"] = new OptionSetValue(StatusTransitionMatrix.PtpStatus.Kept);
            builder.WithTarget(target);
