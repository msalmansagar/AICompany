...
namespace EDP.RuleRuntime.Crm
{
    ...
    /// (qdb_edp_ruleaudit, qdb_edp_ruleexecutionlog). Any attempt to mutate or delete an
    /// existing record throws, making the trail tamper-evident at the platform layer.
    ///
